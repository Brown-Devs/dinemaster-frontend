...
function SubAdminsPage() {
    ...
    const staffData = subAdminsQuery(queryParams);
    ...
    return (
        <InnerDashboardLayout>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2 sm:gap-3 mt-5 w-full mb-4">
                <StatCard2 title={`Total Sub Admins`} value={stats.total} subtitle="All time" loading={statsLoading} Icon={AccountCircleIcon} bg="from-[#1e293b] to-[#0f172a]" />
            ...
            <div className="bg-card p-3 sm:p-6 border border-border rounded-xl w-full">
                <div className="mb-5 flex items-center justify-between">
                    <div>
                        <h2 className="font-semibold text-2xl">Sub Admins List</h2>
                        <p className="text-gray-500 text-sm">View and manage Sub Admins.</p>
                    </div>
                </div>
